...
//       })
//       .catch(() => {
//         toast.error("❌ Failed to fetch PDFs from Drive");
//       });
//   }, []);
...
//         setPdfFiles((prev) => [{ name: file.name, webViewLink: data.fileLink }, ...prev]);
//       } else {
...
//   return (
//     <div className="bg-gradient-to-br from-primary to-primary-dark min-h-screen text-white p-4 md:p-8">
...
//               <form onSubmit={sendQuery} className="space-y-4 relative">
...
//                     className="w-full p-4 pl-10 pr-14 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl text-white placeholder-white/50"
//                     disabled={isLoading}
//                   />
...
//                     <ArrowUpTrayIcon
//                       className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-white/70 hover:text-accent cursor-pointer"
//                       title="Upload PDF"
//                     />
//                   </label>
//                   <input
...
//                   <button
//                     type="submit"
//                     className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-accent hover:bg-accent-dark p-2 rounded-lg"
...
//             {/* 📂 PDF list */}
//             <div className="glass-effect mt-6 p-4 rounded-xl">
//               <h4 className="text-white font-semibold mb-2">Uploaded PDFs</h4>
//               {pdfFiles.length === 0 ? (
//                 <p className="text-white/60 text-sm">No files yet.</p>
//               ) : (
...
//                         className="text-accent hover:text-accent-dark flex items-center text-xs"
//                       >
...
//           <div className="w-full md:w-1/2">
//             <div className="glass-effect p-6 rounded-2xl shadow-xl h-full">
//               <h3 className="text-xl font-semibold mb-4 flex items-center">
//                 <DocumentTextIcon className="w-6 h-6 mr-2 text-accent" />
//                 Search Results
//               </h3>
...
//                     <div
//                       key={index}
//                       className="bg-white/5 p-4 rounded-xl border border-white/10 hover:border-accent/50"
//                     >
//                       <div className="flex justify-between items-start mb-2">
//                         <strong className="font-medium text-accent">{result.pdf_name}</strong>
